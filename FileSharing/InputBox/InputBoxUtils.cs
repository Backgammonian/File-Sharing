...
namespace InputBox
{
    public class InputBoxUtils
    {
        ...
        public bool AskPort(int defaultPort, out int port)
        {
            var inputBox = new InputBoxWindow("Set server port number",
                "Enter port number of local File Server",
        ...
        public bool AskServerAddressAndPort(IPEndPoint defaultEndPoint, out IPEndPoint? serverAddress)
        {
            var inputBox = new InputBoxWindow("Connection to File Server",
                $"Enter IP address of file server (example: {defaultEndPoint.Address}).\n" +
